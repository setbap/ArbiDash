...
This chart shows the total fee paid per day. As you can see, on Jun 29, the Ethereum network experienced its busiest day.
            `}
...
This chart shows the average fee paid per hour of the day. As you can see, transactions need more fees to be done at 5PM and 8PM, and the network is more crowded during these hours. Also at 12AM, the fee is the lowest of all the hours of the day, and the network is quieter.
            `}
